...
export default function Card({score,increasescore,decreasescore,teamName}) {
  return(
       
       <div className='bg-[rgba(173,216,230,0.8)]  w-3.5/4 md:w-1/4 m-8 rounded-xl shadow-2xl'>
       <h1 className='text-center text-2xl md:text-4xl py-2 md:py-4 my-2 md:my-5 border-b-2 border-dotted border-gray-500'>{teamName}</h1>
